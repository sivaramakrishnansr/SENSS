...
attack_duration=200
attack_rate=100
switch_mac="7c:fe:90:f3:a1:41"
server_mac="fa:07:ad:ad:84:fc"
source_ip_start="52.0.0.1"
source_ip_end="52.0.0.2"
legit_traffic=1
legit_traffic_rate=0.5
legit_traffic_start="52.0.0.3"
legit_traffic_end="52.0.0.4"
'''	
...
if type=="alpha":
	...
	print "Legit traffic rate",legit_traffic_rate
	child.sendline('set 1 rate '+str(legit_traffic_rate))
	#child.sendline('set 0 rate '+str(attack_rate))
