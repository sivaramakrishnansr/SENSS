...
for $t (1)
{
	...
	while(1)
	{
		...
		#    $i++;
		#}
		for $a (55770,49846,48163,45700,43639,39836,393560,393234,36183,35994,35993,35204,34850,34164,33905,32787,31377,31110,31109,31108,31107,30675,24319,23903,23455,23454,22207,21399,21357,21342,20940,20189,18717,18680,17334,16702,16625,12222)
		{
		    if (exists($short{$a}))
		    {
			$senss{$a} = 1;
