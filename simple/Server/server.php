...
<div class="container inner-container">
		...
		<div class="alert alert-info" role="alert">
			<b><span id="controller_url_placeholder"></span></b>
		</div>
		<button type="button" class="btn btn-primary btn-small" name="submit" id="add-controller">Set controller</button></span></p>
    	</div>
    	<div class="col-md-8">
        	<h2>Logs</h2>
    	</div>
...
<div id="add-controller-modal" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">Add controller URL</h4>
            </div>

            <div class="modal-body" style="height:400px;">
                <table class="table">
                    <tr>
                        <td><input type="text" id="controller_url" class="form-control"></td>
                    </tr>
                </table>
            </div>

            <div class="modal-footer">
                <div id="add-controller-button" class="btn btn-success">Set controller</div>
            </div>
        </div>
    </div>
</div>
