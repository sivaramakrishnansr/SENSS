...
<body>
	...
	if($_POST['formSubmit'] == "Submit")
	{
		...
		$switch_name=$switch_name.".dhs.senss";
		$ssh = new Net_SSH2($switch_name);
		if (!$ssh->login($switch_username, $switch_password)) {
    			exit('Login Failed!');
		}
		$command_to_exec='sudo python /proj/SENSS/DHS/Setup/switch_setup.py '.$controller_ip.' '.$switch_name.' &';
